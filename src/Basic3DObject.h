#ifndef tCAD_Basic3DObject_h
#define tCAD_Basic3DObject_h
#include "Shape3D.h"
...
public:
    ...
    /*
     convert mesh to meshSet (necessary for ofxCarveCSG)
     */
    ...
    /*
     convert meshset (from ofxCarveCSG) to mesh
     */

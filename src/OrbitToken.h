#ifndef tCAD_Rotater_h
#define tCAD_Rotater_h
...
/*
 Represents orbit token
 */
class OrbitToken
{
    LockableVector<ContainerToken*> * containers;//container tokens on the tabletop
    ExponentialMovingAverageAngle * avg;//angle stabilizer

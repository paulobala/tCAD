#ifndef tCAD_StlSecondMenuOption_h
#define tCAD_StlSecondMenuOption_h
#include "lineIntersection.h"

/*
 On-token Content Creation Option
 */
class OnTokenOption
{
    ofImage stlImg, kinectImg, contourImg, copyImg, leftArrow, rightArrow;//Images for onscreen options

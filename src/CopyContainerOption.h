#ifndef tCAD_CopyContainer_h
#define tCAD_CopyContainer_h

#include "ContainerToken.h"
#include "Basic3DObjectFromCopy.h"
#include "OnScreenOption.h"
/*
 Option for copying content from container token
 */
...
public:
    ...
    ContainerToken * container;//container that option copies
public:
    /*
     Constructor
     */
